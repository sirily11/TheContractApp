...
/// English BIP39 wordlist implementation
public struct EnglishWordlist: BIP39WordlistProtocol, Sendable {
    public static let shared = EnglishWordlist()

    private init() {}

    /// The complete BIP39 English wordlist (2048 words)
    ...
    public func index(of word: String) -> Int? {
        ...
        return words.firstIndex(of: lowercasedWord)
    }
